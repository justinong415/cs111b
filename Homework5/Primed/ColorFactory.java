...
Date: 4 Dec 2017
Course: CS111B
Homework: #5 Color Factory
Objective:
This program has
 - an filled oval on the top left with a color that changes
 - a red, green, and blue slider on the top right that changes the circle's color
 - bars on the bottom left that adjusts, showing how the colors are changed with numeric indicator
 - radio buttons on the right to change display between decimal, octal, binary, or hex
*/
